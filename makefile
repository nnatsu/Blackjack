finalProject: main.o hit.o evaluate1.o rounds.o winnings1.o dealing.o userInput.o
	gcc -o finalProject main.o hit.o evaluate1.o rounds.o winnings1.o dealing.o userInput.o
